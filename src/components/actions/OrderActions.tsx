...
import { Order, StatusHistoryEntry, OrderPaymentStatus, OrderStatus, StatusAction } from '@typings/models'
import { apiVersion, baseLanguage } from '@helpers/globals'
import {
...
export function OrderActionContent(
  ...
  const frontendClient = useFrontendClient(order?.locale || baseLanguage.locale)
